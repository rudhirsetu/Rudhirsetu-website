          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-red-700 mt-1 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">93216 06868</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">rudhirsetu@rudhirsetu.org</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="flex items-center justify-center bg-red-50 p-4 rounded-lg">
                <svg className="w-6 h-6 text-red-700 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-xl font-bold text-red-700">93216 06868</span>
              </div>
            </div>
          </div>
        </div>
